    ...
    <section className="bg-cream py-16 px-8 md:px-20 lg:px-24">
      <div className="container-wide flex flex-col md:flex-row items-center justify-between gap-8">
        ...
        <div className="flex gap-4 items-center">
          {/* Facebook */}
          <a href="#" className="text-teal hover:text-teal-light transition-colors">
      ...
      <div className="container-wide mt-8 flex flex-col sm:flex-row gap-4">
        <input
          ...
          className="flex-1 max-w-md px-6 py-3 border border-gray-300 rounded-full text-gray-700 focus:outline-none focus:border-teal"
        />
        <button className="bg-copper text-white font-semibold tracking-wider px-8 py-3 rounded-full hover:opacity-90 transition-opacity flex items-center gap-2">
          Sign me up
